module AHB_Decoder (
    ...
    // outputs
    output reg [1:0] HSELx_slaves, // FIX: reg required because assigned inside always block
    output reg [1:0] HSELx_Mux // FIX: reg required because assigned inside always block
);
